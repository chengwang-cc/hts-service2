...
const QUERIES = [
  // Raw hides - should no longer be EMPTY after CC
  ...
  // Upper leather grain splits → ch.64 (AI_CH64_SHOE_UPPER still has "leather upper"?)
  "Upper leather Upper leather lining leather Grain splits",
  // Leather parings flour → should be open after BB
  ...
  // Beef in airtight → should be ch.16 after PREPARED_CANNED_MEATS_INTENT

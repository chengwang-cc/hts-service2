...
const QUERIES = [
  // ch.26 vanadium residues → ch.81
  "Containing mainly vanadium Other",
  // Any ch.81 metal rules that might fire for vanadium?
  "Vanadium molybdenum tungsten bismuth",
  // ch.20 nectarines → ch.08 (still failing)
  "Other Nectarines Peaches including nectarines",
  // ch.12 carrot seeds → ch.07 (still failing)
  "Carrot",
  // ch.16 crustaceans prepared → ch.03 (still failing)
  "Other Other Other crustaceans",
  // ch.72 → ch.74 thickness

...
const QUERIES = [
  // ch.05 feathers/bird skins → EMPTY
  ...
  // ch.54 synthetic filament after HH (yarn intent now has 54)
  ...
  // ch.90 optical lenses/mirrors after HH

...
const QUERIES = [
  // ch.30 medicaments → ch.40 (rubber articles)
  "Other Other Medicaments excluding goods of heading 3002 3005 or 3006 consisting of two or more constituents which have been mixed together for therapeutic or prophylactic uses not put up in measured doses or in forms or packings for retail sale",
  "Antiprotozoals excluding goods described in subheading note 2 to this chapter Other Medicaments excluding goods of heading 3002 3005 or 3006 consisting of two or more constituents which have been mixed together for therapeutic or prophylactic uses not put up in measured doses or in forms or packings for retail sale",
  // ch.84 kW → ch.85 (electric motors)
  "Exceeding 2.2 kW but not exceeding 7.5 kW Other Other",
  // ch.38 Clay → ch.25
  "Clay",
  // ch.61 knitted vs ch.62 woven
  "Men s or boys Other Of other textile materials",
  "Shirts Of artificial fibers",
  // ch.16 crustaceans → ch.03
  "Other Other Other crustaceans",
  // ch.26 vanadium → ch.81
  "Containing mainly vanadium Other",
  // ch.84 EMPTY bending folding
  "Used or rebuilt Other numerically controlled bending folding straightening or flattening machines",
];

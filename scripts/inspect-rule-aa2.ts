...
async function main() {
  ...
  try {
    ...
    const targetRules = [
      'AUTOMOTIVE_INTERIOR_PARTS_INTENT',
      'PRINTED_MATTER_CATALOGUE_INTENT',
      'AI_CH92_WHISTLE_DECOY',
      'FAN_VENTILATION_COOLING_INTENT',
      'AI_CH69_CERAMIC_DINNERWARE_SET',
      'PLASTIC_TOY_FIGURINE_INTENT',
      'APOTHECARY_GLASS_CONTAINER_INTENT',
      'PLUSH_STUFFED_TOY_INTENT',
      'CLUTCH_BAG_INTENT',
      'AI_CH03_MOLLUSCS',
      'COFFEE_MAKER_INTENT',
      'JEWELRY_RING_INTENT',
      'AI_CH89_INFLATABLE_RAFT',
      'SOCCER_BALL_INTENT',
      'AI_CH22_BRANDY_COGNAC',
    ];

...
const QUERIES = [
  // ch.05 feathers/bird skins → should be OPEN (no chapter restriction)
  "Feathers of a kind used for stuffing down Skins and other parts of birds with their feathers or down feathers and parts of feathers whether or not with trimmed edges and down not further worked than cleaned disinfected or treated for preservation powder and waste of feathers or parts of feathers",
  // ch.56 wadding — should still fire
  "Wadding of man-made fibers batting nonwovens",
  // ch.56 stuffing material (generic) — should fire
  "Stuffing material for pillows and cushions",
];

...
const QUERIES = [
  // ch.16 beef in airtight containers → ch.86 (containers)
  "Other Beef in airtight containers",
  // ch.12 seeds → ch.07 vegetables
  "Carrot",
  "Tomato",
  // ch.12 sunflower seeds → ch.08 (fruits!)
  "Other Sunflower seeds whether or not broken",
  // ch.44 wooden sticks → ch.66 (umbrella/walking sticks)
  "Coniferous Hoopwood split poles piles pickets and stakes of wood pointed but not sawn lengthwise wooden sticks roughly trimmed but not turned bent or otherwise worked suitable for the manufacture of walking-sticks umbrellas tool handles or the like chipwood and the like",
  // ch.62 blouses wool → ch.51
  "Subject to wool restraints Of other textile materials Women s or girls blouses shirts and shirt-blouses",
  // ch.41 leather dust powder flour → ch.11

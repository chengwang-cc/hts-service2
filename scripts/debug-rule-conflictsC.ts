...
const QUERIES = [
  // ch.93 failures
  "Other Other Other firearms and similar devices which operate by the firing of an explosive charge for example sporting shot- guns and rifles muzzle-loading firearms Very pistols and other devices designed to project only signal flares pistols and revolvers for firing blank ammunition captive-bolt humane killers line-throwing guns",
  "Telescopic sights imported with rifles Valued over 25 but not over 50 each",
  "Rocket launchers flame-throwers grenade launchers torpedo tubes and similar projectors Military weapons other than revolvers pistols and the arms of heading 9307",
  // ch.87 → ch.31: hybrid bus → fertilizer
  "Other With both compression-ignition internal combustion piston engine diesel or semi-diesel and electric motor as motors for propulsion Motor vehicles for the transport of ten or more persons including the driver",
  // ch.29 → ch.54: vinyl acetate → fabric
  "Vinyl acetate",
];

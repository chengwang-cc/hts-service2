#!/usr/bin/env ts-node
// FIXED version: uses entry.expectedChapter + autocomplete filter + hasPositiveCondition
...
async function main() {
  ...
  try {
    ...
    const targetRules = [
      'SEMI_PRECIOUS_STONE_MARBLE_INTENT',
      'CHARACTER_LICENSED_BEDDING_INTENT',
      'CUTLERY_SET_INTENT',
      'AI_CH92_UPRIGHT_PIANO',
      'SKINCARE_INTENT',
      'RULER_COMPASS_INTENT',
      'AI_CH92_HARP',
      'AI_CH36_EXPLOSIVES',
      'AI_CH06_ORNAMENTAL_FOLIAGE',
      'LIP_PRODUCT_INTENT',
      'AI_CH06_BULBS_CORMS',
      'AI_CH19_SWEET_BISCUIT_COOKIE',
      'POLYMER_CLAY_INTENT',
      'RECORDED_MEDIA_VHS_DVD_INTENT',
      'AI_CH02_SALTED_CURED_MEAT',
    ];

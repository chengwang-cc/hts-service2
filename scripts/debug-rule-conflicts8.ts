...
const QUERIES = [
  "For men Wither uppers of vegetable fibers and having outer soles with textile materials having the greatest surface area in contact with the ground but not taken into account under the terms of additional U.S. note 5 to this chapter",
  "For women With uppers of vegetable fibers With uppers of textile materials",
  // Look at other remaining failures
  "Other crustaceans",

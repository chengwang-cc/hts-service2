...
const QUERIES = [
  // New failure: hard magnetic disk drive → ch.22 (beverages!)
  "Hard magnetic disk drive units Other",
  // ch.26 vanadium → ch.81
  "Containing mainly vanadium Other",
  // ch.26 slag residues → wrong ch.26 subcode
  "Other Slag ash and residues other than from the manufacture of iron or steel containing arsenic metals or their compounds",
  // ch.84 sterilizers still EMPTY (post-NN)
  "Medical surgical or laboratory sterilizers Machinery plant or laboratory equipment whether or not electrically heated",
  // ch.15 olive pomace oil still EMPTY post-NN (server reload pending)
  "Other Crude olive pomace oil",
  // ch.25 silica sands still ch.71 post-NN (server reload pending)
  "Sand containing by weight 95 percent or more of silica and not more than 0.6 percent of oxide of iron Silica sands and quartz sands Natural sands of all kinds",
];

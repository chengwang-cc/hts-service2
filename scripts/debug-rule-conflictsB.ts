...
const QUERIES = [
  // New EMPTY
  "Other Vegetable materials and vegetable waste vegetable residues and byproducts whether or not in the form of pellets of a kind used in animal feeding not elsewhere specified or included",
  // Check potential other empties based on current failures

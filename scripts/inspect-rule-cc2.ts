...
async function main() {
  ...
  try {
    ...
    const targetRules = [
      'INDOOR_PLANT_INTENT',
      'BABY_CRIB_INTENT',
      'OILSEEDS_CH12_INTENT',
      'DAIRY_INTENT',
      'PAPER_BANNER_PENNANT_INTENT',
      'MAKEUP_BLUSH_INTENT',
      'BRONZER_BLUSH_INTENT',
      'AI_CH89_INFLATABLE_BOAT',
      'HANDMADE_WASHI_PAPER_INTENT',
      'CONDIMENT_SAUCE_INTENT',
      'PERFUME_INTENT',
      'SODA_BEVERAGE_INTENT',
      'AI_CH19_PASTRY_CAKE',
      'AI_CH19_TAPIOCA',
      'AI_CH17_INVERT_SUGAR',
    ];

...
const QUERIES = [
  // ch.61 knitted vs ch.62 woven — need rules to detect knitted context
  "Men s or boys Other Of other textile materials",
  "Shirts Of artificial fibers",
  "Other Of synthetic fibers Women s or girls suits ensembles suit-type jackets blazers dresses skirts",
  // ch.84 → ch.85 kW (expected 8418 refrigerator/compressor parts)
  "Exceeding 2.2 kW but not exceeding 7.5 kW Other Other",
  // ch.87 GVW trucks (within-ch but cross-subch)
  "G.V.W. exceeding 5 metric tons but not exceeding 9 metric tons",
  // ch.30 → verify RR fix worked for medicaments
  ...
  // ch.84 bending folding → verify RR fix for umbrella
  "Used or rebuilt Other numerically controlled bending folding straightening or flattening machines",
  // ch.12 seeds in shell (Carrot, Tomato seed context)
  "Carrot",
  // more potential empty result queries
  "Slag ash and residues other than from the manufacture of iron or steel containing arsenic metals",
];

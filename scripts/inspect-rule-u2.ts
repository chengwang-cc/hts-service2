...
async function main() {
  ...
  try {
    ...
    const targetRules = ['AI_CH88_HANG_GLIDER', 'FAUX_FUR_PILE_FABRIC_INTENT', 'WINE_INTENT', 'AI_CH54_RAYON_FABRIC', 'SYNTHETIC_MMF_YARN_INTENT', 'LEATHER_JACKET_INTENT', 'AI_CH65_DISPOSABLE_CAP', 'AI_CH67_WIGS_HAIRPIECES', 'PRESS_ON_NAIL_BEAUTY_INTENT', 'CANDLE_HOME_INTENT', 'STAINED_GLASS_FLAT_INTENT', 'AI_CH59_COATED_FABRIC_PVC_PU', 'SEWING_SUPPLIES_INTENT', 'SHIRT_GARMENT_BACKUP_INTENT', 'STICKER_SHEET_PAPER_INTENT'];

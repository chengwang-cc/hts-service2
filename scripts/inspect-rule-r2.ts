...
async function main() {
  ...
  try {
    ...
    const targetRules = ['YARN_INTENT', 'SHIRT_GARMENT_BACKUP_INTENT', 'STATIONERY_NOTEBOOK_INTENT', 'BEANIE_HAT_INTENT', 'AI_CH02_OFFAL', 'DIAMOND_PAINTING_INTENT', 'WOOD_LASER_DECOR_INTENT', 'FIBERGLASS_COMPOSITE_INTENT', 'BICYCLE_INTENT', 'DAIRY_INTENT', 'SPORTS_BALL_INTENT', 'SILICONE_MOLD_INTENT'];

...
async function main() {
  ...
  try {
    ...
    const targetRules = [
      ...
      'BALLOON_INTENT',
      'AI_CH22_SPIRITS_BRANDY_COGNAC',
      'SHIRT_GARMENT_BACKUP_INTENT',
      'TEMPERED_GLASS_SCREEN_INTENT',
      'AI_CH06_LIVE_ROSES_TREES_SHRUBS',
      'PASTA_NOODLE_INTENT',
      'PASTA_FOOD_INTENT',
      'JEWELRY_CASE_VELVET_BOX_INTENT',
      'WRISTWATCH_ANALOG_INTENT',
      'AI_CH46_WOVEN_HANDBAG_PURSE',
      'BOOK_NOVEL_PAPERBACK_INTENT',
    ];

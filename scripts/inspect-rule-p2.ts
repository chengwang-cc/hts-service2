...
async function main() {
  ...
  try {
    ...
    const targetRules = ['AI_CH54_ELASTOMERIC_YARN', 'YARN_INTENT', 'AI_CH13_NATURAL_GUMS_RESINS', 'SEAFOOD_FISH_INTENT', 'CHRISTMAS_ORNAMENT_INTENT', 'AI_CH24_ECIG_VAPE', '3D_PRINT_PLASTIC_INTENT', 'TEA_INTENT', 'BED_SHEET_INTENT', 'TOWEL_INTENT', 'AI_CH89_CABIN_CRUISER', 'BEANIE_HAT_INTENT'];

...
const QUERIES = [
  // ch.61 cashmere sweaters → ch.51
  "Wholly of cashmere Of Kashmir cashmere goats Sweaters pullovers sweatshirts waistcoats vests and similar articles knitted or crocheted",
  // ch.62 worsted wool trousers → ch.52
  "Trousers of worsted wool fabric made of wool yarn having an average fiber diameter of 18.5 microns or less",
  // ch.12 peanuts in shell → ch.89
  "Other Other In shell",
  // ch.07 truffles → ch.06
  "Truffles Tuber spp.",
  // ch.07 "Other Head lettuce cabbage lettuce" → ch.03
  "Other Head lettuce cabbage lettuce",
  // ch.90 cameras → ch.90 wrong (Cameras alone)
  "Cameras",
  // ch.72 steel thickness → within-chapter

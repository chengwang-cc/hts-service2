...
async function main() {
  ...
  try {
    ...
    const targetRules = ['WOOD_LASER_DECOR_INTENT', 'SPORTS_BALL_INTENT', 'CAMERAS_CINEMATOGRAPHIC_INTENT', 'JEWELRY_BRACELET_INTENT', 'CLOCK_TIMEPIECE_INTENT', 'SHOELACE_LEATHER_STRAP_INTENT', 'AI_CH91_TIME_SWITCH_TIMER', 'AI_CH58_EMBROIDERY_FABRIC', 'AI_CH36_METALDEHYDE', 'COFFEE_BEAN_INTENT', 'SCREW_BOLT_INTENT', 'AI_CH36_FUSES_DETONATORS', 'CEMENT_CONCRETE_INTENT', 'POLYPROPYLENE_TOUGH_COAT_INTENT', 'OUTERWEAR_JACKET_GARMENT_INTENT'];

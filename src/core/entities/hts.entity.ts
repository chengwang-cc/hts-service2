...
export class HtsEntity {
  ...
  @Column('jsonb', { nullable: true })
  adjustedFormulaVariables: Array<{
    name: string;
    type: string;
    description?: string;
    unit?: string;
  ...
  /**
   * P1.7 — sha256(canonical rate text) at the moment the current formula
   * was generated. The stale-formula scan compares this against the
   * current rate text to detect drift.
   */
  @Column('varchar', { length: 64, nullable: true })
  rateTextHash: string | null;

  /**
   * P1.7 — confidence reported by the formula generator (0..1). Used by
   * the stale scan to flag low-confidence rows for regeneration.
   */
  @Column('decimal', { precision: 3, scale: 2, nullable: true })
  formulaConfidence: number | null;

  /**
   * P1.7 — when the current formula was last generated.
   */
  @Column('timestamptz', { nullable: true })
  formulaGeneratedAt: Date | null;

  /**
   * P1.7/P1.8 — FK to the source_citations row that produced this formula.
   */
  @Column('uuid', { nullable: true })
  formulaSourceCitationId: string | null;

  /**
   * Search Vector - Full-text search vector (auto-generated by DB trigger)
   * Combines hts_number and description for fast full-text search
   */
